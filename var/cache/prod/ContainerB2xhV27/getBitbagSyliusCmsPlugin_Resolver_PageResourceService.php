...
return $this->services['bitbag_sylius_cms_plugin.resolver.page_resource'] = new \BitBag\SyliusCmsPlugin\Resolver\PageResourceResolver(($this->services['bitbag_sylius_cms_plugin.repository.page'] ?? $this->load('getBitbagSyliusCmsPlugin_Repository_PageService.php')), ($this->services['sylius.context.locale'] ?? $this->getSylius_Context_LocaleService()), ($this->privates['monolog.logger'] ?? $this->load('getMonolog_LoggerService.php')));
